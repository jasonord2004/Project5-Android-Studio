...
/**
 * This class handles the pizza selection process for the NYPizza factory and adds the pizza to the order.
...
public class NYPizzaController {
    ...
    void setCrust(){
        switch(TypeComboBox.getValue()){
            case "Build Your Own": CrustTextField.setText("Hand-Tossed");break;
            case "BBQ Chicken": CrustTextField.setText("Thin"); break;
            case "Deluxe": CrustTextField.setText("Brooklyn"); break;
            case "Meatzza": CrustTextField.setText("Hand-Tossed"); break;
            default: break;
        }
    }
    ...
    void setPicture(){
        try {
            switch (TypeComboBox.getValue()) {
                case "Build Your Own":
                    Image yourOwn = new Image(getClass().getResource("Build-Your-Own-NY.jpg").openStream());
                    CSPizzaImage.setImage(yourOwn);
                    break;
                case "BBQ Chicken":
                    Image bbq = new Image(getClass().getResource("BBQ-NY.jpg").openStream());
                    CSPizzaImage.setImage(bbq);
                    break;
                case "Deluxe":
                    Image deluxe = new Image(getClass().getResource("Deluxe-NY.jpg").openStream());
                    CSPizzaImage.setImage(deluxe);
                    break;
                case "Meatzza":
                    Image meatzza = new Image(getClass().getResource("Meatzza-NY.jpg").openStream());
